...
SECRET_KEY = 'django-insecure-1j26s82_dqh3**-$doq5t^n+)=3ch&jy!aat7y2mj#)4)#y4lk'
...
# Répertoire où collectstatic va copier les fichiers pour la production
# STATIC_ROOT = 'U:\\djangogirls\\blog\\static' # Commentez cette ligne pour le développement
